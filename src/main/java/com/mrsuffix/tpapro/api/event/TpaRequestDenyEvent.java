...
public final class TpaRequestDenyEvent extends TpaRequestEvent implements Cancellable {
    private static final HandlerList HANDLERS = new HandlerList(); private boolean cancelled;
    public TpaRequestDenyEvent(TeleportRequest.Snapshot request) { super(request); }
