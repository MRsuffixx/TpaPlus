...
public final class TpaRequestCreateEvent extends TpaRequestEvent implements Cancellable {
    private static final HandlerList HANDLERS = new HandlerList(); private boolean cancelled;
    public TpaRequestCreateEvent(TeleportRequest.Snapshot request) { super(request); }
